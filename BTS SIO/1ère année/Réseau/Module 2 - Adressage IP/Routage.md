...
- **Protocoles de routage dynamiques** : Ces protocoles permettent aux routeurs d'échanger des informations sur les routes. Exemples : [[BTS SIO/1ère année/Réseau/Module 5 - Routage Dynamique/RIP|RIP]], OSPF, BGP.