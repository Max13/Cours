...
+  <nav class="docs-toc col" aria-label="Secondary navigation">
...
rm __site/zola/static/android-chrome* \
   __site/zola/static/apple-touch* \
   __site/zola/static/browserconfig.xml \
   __site/zola/static/favicon* \
   __site/zola/static/site.webmanifest
mv __obsidian/_www/icons __site/
